...
const uData = customersByDevice.map(t => t.web_sales);
const pData = customersByDevice.map(t => t.offline_sales)
const xLabels = customersByDevice.map(t => new Date(t.date).toLocaleDateString("en-GB", {
    day: "numeric",
    month: "numeric",
    year: "numeric"
}));
